...
urlpatterns = [
    ...
    path("clonedisk/<pk>/", views.clone_disk),
    path("cancelwipe/<celeryid>/", views.cancel_wipe),
    path("cancelclone/<celeryid>/", views.cancel_clone),
    ...
    path("getclones/", views.get_clones),
    path("cloneprogress/", views.clone_progress),
    path("getlatestwipe/", views.get_latest_wipe),
    path("getlatestclone/", views.get_latest_clone),
